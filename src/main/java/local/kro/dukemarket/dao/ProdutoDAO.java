 ...
 */
package local.kro.dukemarket.dao;
...
public class ProdutoDAO {
     ...
     * @param id Identificação de Produto
     * @return
     */ 
    public Produto getResultById(int id){
        ...
        try {
            ...
            if (rs.next()){
                p = new Produto();
                p.setId(rs.getInt("id"));
                p.setCodBarras(rs.getString("cosBarras"));
                p.setDescricao(rs.getString("descricao"));
                p.setQtd(rs.getDouble("qtd"));
                p.setValorCompra(rs.getDouble("valorCompra"));
                p.setValorVenda(rs.getDouble("valorVenda"));
    ...
    public void update(Produto p){
        ...
        try{
            ...
            //Encerra a conexão com o bacno e o statement.
            MySQLConnection.closeConnection(conn, stmt);
        }
    ...
    /**
     * Exclui um produto com base de ID fornecido
